...
class Generator {
  ...
  static String generateStringClass(
    ...
    String header = """
      ${_buildNestedImports(genClass, options)}
...
//    print(output);
  ...
  static String _buildNestedImports(
    ...
    """;
    baseImports += genClass.fields.any((GenField field) =>
    ...
    List<String> items = genClass.fields
        // exclude class name
        .where((element) => (genClass.name.compareTo(element.type.name) != 0))
